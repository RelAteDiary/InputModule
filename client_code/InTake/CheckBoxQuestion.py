...
class CheckBoxQuestion:
    def __init__(
        ...
        for value in value_to_questions:
            ...
            checkbox.add_event_handler("change", self._change_selected(checkbox, value))
        ...
        if has_other_textbox:
            ...
            self.other_checkbox = Checkbox(
                text="Other", checked=len(existing_other_texts) > 0
            )
            self.other_checkbox.add_event_handler("change", self._show_other_textbox)
            ...
            self.other_text = TextBox(
                ...
                text=""
                if len(existing_other_texts) == 0
                else existing_other_texts[0][len("other-") :],
            )
        ...
        if prev_button_link is not None:
            ...
            self.prev_button.add_event_handler("click", self._update_question_answer)
        ...
        if next_button_link is not None:
            ...
            self.next_button.add_event_handler("click", self._update_question_answer)
    ...
    def _update_question_answer(self, **event_args):
        ...
        anvil.server.call("intake_set_answer", self.question_id, self.selected)
